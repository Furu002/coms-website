...
export default function SplitLogoCard() {
  ...
  return (
    <div className="relative mx-auto aspect-square w-full max-w-[min(90vw,40rem)] select-none">
      <div
        className="pointer-events-none absolute inset-0 z-30 flex items-center justify-center text-center font-black uppercase tracking-[-0.1em] text-[#ffffff]"
        style={{
          ...
          fontSize: 'clamp(4.4rem, 11vw, 12rem)',
          lineHeight: '0.78',
        }}
      >
        KW COM&apos;s
